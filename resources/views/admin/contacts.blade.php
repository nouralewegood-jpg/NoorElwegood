                            ...
                            <div class="main-contacts-list" id="mainContactList">
                                ...
                                <div class="main-contact-item selected">
                                    <div class="main-img-user online"><img alt="avatar"
                                            src="{{ URL::asset('assets-admin/img/faces/2.jpg') }}"></div>
                                ...
                                <div class="main-contact-item">
                                    <div class="main-img-user online"><img alt="avatar"
                                            src="{{ URL::asset('assets-admin/img/faces/5.jpg') }}"></div>
                                    <div class="main-contact-body">
                    ...
                    <div class="main-contact-info-header pt-3">
                        <div class="media">
                            <div class="main-img-user">
                                <img alt="avatar" src="{{ URL::asset('assets-admin/img/faces/6.jpg') }}"> <a
