...
@section('content')
        ...
        <div class="col-md-4 col-lg-4 mg-md-t-0">
            <div class="card">
                <div class="card-body ">
                    ...
                    src="{{ URL::asset('assets-admin/img/photos/11.jpg') }}">
            </div>
        </div><!-- col-4 -->
    </div>
    <!-- /row closed -->
    ...
    <div class="row row-sm">
        <div class="col-md">
            <div class="card">
                <img alt="Image" class="img-fluid card-img-top"
                    src="{{ URL::asset('assets-admin/img/photos/3.jpg') }}">
        ...
        <div class="col-md mg mg-md-t-0">
            <div class="card">
                <img alt="Image" class="card-img img-fluid card-img-top"
                    src="{{ URL::asset('assets-admin/img/photos/5.jpg') }}">
                <div class="card-img-overlay pd-30 bg-black-4 d-flex flex-column justify-content-center">
        ...
        <div class="col-md mg-md-t-0">
            <div class="card">
                <img alt="Image" class="card-img img-fluid card-img-top"
                    src="{{ URL::asset('assets-admin/img/photos/6.jpg') }}">
                <div class="card-img-overlay pd-30 bg-black-4 d-flex flex-column justify-content-center">
