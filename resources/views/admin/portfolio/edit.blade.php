        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">تعديل عمل</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="col-12">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">تعديل العمل: {{ $portfolio->title }}</h3>
                    </div>
                    <!-- /.card-header -->
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            name="client_name" value="{{ old('client_name', $portfolio->client_name) }}">
                                        @error('client_name')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('tags') is-invalid @enderror"
                                    id="tags" name="tags" value="{{ old('tags', $portfolio->tags) }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="mb-2">
                                    ...
                                    @else
                                        <p class="text-muted">لا توجد صورة محددة</p>
                                    @endif
                                </div>
                            </div>

                            <div class="form-group">
                                <label for="image">تغيير الصورة الرئيسية</label>
                                ...
                                <small class="form-text text-muted">اترك هذا الحقل فارغاً إذا كنت لا ترغب في تغيير الصورة
                                    الحالية</small>
                                @error('image')
                            ...
                            @if ($portfolio->gallery && count($portfolio->gallery) > 0)
                                <div class="form-group">
                                    <label>الصور الحالية في المعرض</label>
                                    <div class="row">
                                        @foreach ($portfolio->gallery_urls as $index => $imageUrl)
                            ...
                            <div class="form-group">
                                <label for="gallery">إضافة صور جديدة للمعرض</label>
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input type="file"
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number"
                                            ...
                                            value="{{ old('display_order', $portfolio->display_order) }}" min="0">
                                        @error('display_order')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" id="active"
                                                name="active" value="1"
                                                {{ old('active', $portfolio->active) ? 'checked' : '' }}>
