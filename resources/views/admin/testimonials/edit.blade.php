    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ آراء العملاء / تعديل رأي</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">تعديل رأي العميل</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="quote" id="quote" class="form-control" rows="4" required>{{ old('quote', $testimonial->quote) }}</textarea>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <div class="rating-stars block" id="rating">
                                        <input type="number" readonly class="rating-value" name="stars"
                                            id="rating-stars-value" value="{{ old('stars', $testimonial->stars ?? 5) }}">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div id="image-preview" class="mt-2" style="display: none;">
                                        <img src="" alt="معاينة الصورة الجديدة"
                                            style="max-height: 150px; max-width: 150px; border-radius: 50%;">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="ordering" id="ordering" class="form-control"
                                        value="{{ old('ordering', $testimonial->ordering) }}" required>
                                </div>
                            </div>
                            <div class="col-lg-3">
